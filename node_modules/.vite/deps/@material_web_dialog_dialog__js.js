...
var Dialog = class extends LitElement {
  ...
  handleClose() {
    ...
    this.escapePressedWithoutCancel = false;
    (_a = this.dialog) == null ? void 0 : _a.dispatchEvent(new Event("cancel", { cancelable: true }));
  }
  handleKeydown(event) {
    if (event.key !== "Escape") {
      return;
  ...
  async animateDialog(animation) {
    var _a;
    (_a = this.cancelAnimations) == null ? void 0 : _a.abort();
  ...
  handleFocusTrapFocus(event) {
    ...
    if (!firstFocusableChild || !lastFocusableChild) {
      (_a = this.dialog) == null ? void 0 : _a.focus();
      return;
    }
